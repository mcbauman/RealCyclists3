...
// Toxy 26 Zoll
  ...
  // ReifenwahlTriple
  {
    ...
    // bigPicture: top, topright, right, bottomright, bottom, bottomleft, left, topleft
    // normal: right, left
    title:"Die Perspektiven der Reifenwahl",
    text:"",
    content:[
      {
  ...
  // Mein Cube Editor
  {
    ...
    videoLink:false,
    orientation:"top",
    title:"Warum ich ein 'Cube Editor' fahre",
    text:"Eigentlich bin ich ein Fan des Gravelbikes bzw. Liegerades. Nun und dennoch hab ich einen Cube Editor. Dabei musste ich ihn noch für ca 400,- €uro anpassen. Warum hat das Sinn gemacht?",
    content:[
      {
        title:"Innovationen",
        text:""
      ...
      {
        title:"vielfälltiger Einsatzzweck",
        text:""
      }
    ]
  },
  // Nabenschaltungen
  {
    ...
    content:[
      {
        title:"Wenn ist die Kettenschaltung mist ist",
        text:"Die Kettenschaltung ist von den Rahmendaten in vielen Bedingungen überlegen. Sie ist günstig, leicht und hat eine unübertroffene Effizienz. Bei schlechtem Wetter ist sie aber sehr Plfegeintensiv. Nach einer Stunde Radfahrt bei schlechtem Wetter muss - bzw. sollte Sie komplett gereinigt und neu gefettet werden. Damit ist sie für den täglichen Einsatz nicht geeignet. Die Alternative bei Regen oder Schlechtwetter ist der Riemenantrieb. Der muss nach Regenfahrten in der Regel garnicht behandelt werden. Ab und zu eventuell doch mal mit Wasser absprühlen wird aber auch nicht schaden. Nun setzt ein Riemenantrieb aber leider eine Nabenschaltung oder Getriebenabe vorraus."
      },
      {
        title:"Dynamik",
        text:"Nabenschaltunten sind träge. Die ca. 2 Kilo einer Nabenschlatung sitzen im Hinterrad und müssen mitbeschleunigt werden. Damit ist die Agilität beim Beschleunigen verschwunden. Ist die Endgeschwindigkeit erstmal erreicht, spielt das Gewicht kaum noch eine Rolle, die Geschwindigkeit wird sogar träger gehalten. Die Ausnahme ist ist die Pinion Getriebeschaltung im Tretlager. Damit wird der Hinterreifen sogar noch wesentlich leichter, alls bei Kettenschaltungen."
      },
      {
        title:"Wirkungsgrad",
        text:"Der Wirkungsgrad von Nabenschaltungen liegt leider relativ weit von Kettenschaltungen entfernt. Erschwerend kommt hinzu, dass der Leistungsverlust für die Mechanik der Nabe gerade in den Hohen gängen auch noch zunimmt. Hier geben Sie die untschiedlichen Modelle leider auch erschreckend wenig. Allein die Rohloff Nabe mit 14 Gängen sticht hier positiv aus der Masse hervor und kommt Kettenschaltungen schon recht nahe. Alfine 8/11 Gang und Pinion kommen mit deutlichen Abstand. Ganz weit abgeschlagen landet die Nuvinci - eher an E-Bikes verkraftbar"
      },
      {
        title:"Gänge und Abstufung",
        text:"Derweil sich Kettenschaltungen sehr fein an die persönlichen Wünsch anpassen lassen, ist dies bei Nabenschaltungen nicht möglich. Freilich sind die Gangsprünge für viele Radler sehr gut. Im Sportlichen Bereich reichen Sie aber schnell nicht mehr aus. Möchte man zum Beispiel eine kurze Abstufung der höhehren Gänge und eine große Spreizung für die kleinen, bei Nabenschlatungen keine Chance. Die Entfaltungen sind zwar Teilweise sehr gut. Die Sprünge bei den Höheren Gängen aber viel zu groß für sportliche Fahrer."
      }
    ]
  },
  // toxy Flite
...
// RadReise Dänemark
  ...
  // Gravelbike
  {
    ...
    videoLink:false,
    orientation:"top",
    title:"Gravelbike, der neue Allrounder",
    text:"Warum das Gravelbike das Trekkingrad ablöst",
    content:[
      {
        title:"Innovationen",
        text:""
  ...
  // Liegerader
  {
    ...
    orientation:"top",
    title:"Liegeräder",
    text:"Es gibt Fahrräder, auf die man sich setzt – und es gibt das Toxy TT. Wer sich zum ersten Mal hineinlegt, spürt sofort: Hier beginnt kein gewöhnlicher Radvergleich, sondern ein Perspektivenwechsel. Statt auf einem Sattel zu sitzen, liegt man entspannt in einer ergonomisch geformten Schale. Diese Haltung ist so bequem, dass man problemlos den ganzen Tag im Sattel – oder besser gesagt: in der Schale – verbringen kann. Vor allem dort, wo klassische Räder irgendwann protestieren – im Gesäß, in den Weichteilen, im Nacken – herrscht hier eine beinahe luxuriöse Ruhe. Auch der Oberkörper bleibt komplett entspannt. Die Hände müssen nichts abstützen, hängen locker an den Lenkgriffen, ohne jeden Druck. Taube Finger? Verspannte Schultern? Das gehört alles in die Welt der Aufrechtfahrer. Auf dem Toxy TT fühlt sich das Radfahren obenrum beinahe meditativ an. Und wenn man möchte, fährt man auch mal längere Zeit nur mit einer Hand – einfach, weil es geht.",
    content:[{
      title:"Aufmerksamkeit garantiert – zumindest von Kindern",
      text:"Wer mit einem Liegerad unterwegs ist, fällt auf. Kinder reagieren dabei immer am ehrlichsten. „Schau mal, ein Rennauto-Fahrrad!“, rufen sie, oft begleitet von wildem Winken. Erwachsene sehen meist erst prüfend hin, dann fragend, und man kann ihnen förmlich ansehen, wie sie versuchen zu verstehen, ob dieses Gefährt stabil ist oder mutig. Was fast niemand vermutet: Wie viel Spaß es macht."},
      {
        title:"Ein neuer Anfang – und ein Lernprozess, der nichts mit Intuition zu tun hat",
        text:"Das Fahren selbst ist keine kurze Eingewöhnung, sondern eher eine Neuentdeckung des Radfahrens. Viele Reflexe, die man jahrzehntelang automatisiert hat, funktionieren hier schlicht nicht: kein Wiegetritt, kein schnelles Ausgleichen über den Oberkörper, keine intuitive Balanceübertragung. Und das Lenken - irgendwie komplett anders. Die eigentliche Herausforderung zeigt sich aber nicht auf den Geraden, sondern erst an den ersten Steigungen. Dort beginnt eine Phase, die man am ehesten als „sanfte Demütigung“ bezeichnen könnte – allerdings wirklich nur bergauf. Auf ebener Strecke gleitet man bereits souverän dahin, fast mühelos, doch sobald die Straße anzieht, zeigt das Liegerad seine ganz eigene Lernkurve. Wochenlang wundert man sich, warum Rentner mit Tiefeinsteiger-Fahrrädern fröhlich lächelnd an einem vorbeiziehen, während man selbst die perfekte Balance aus Trittfrequenz, Linienwahl und Stabilität noch sucht. Ohne Wiegetritt muss die Kraft ausschließlich aus den Beinen kommen, und bis die Technik reift, dauert es. Doch dieser Lernprozess ist nicht endlos. Irgendwann – und meistens ganz unspektakulär – klickt es. Die Bewegungen werden runder, der Druck gleichmäßiger, die Balance selbstverständlich. Die Demütigung weicht dem Verständnis – und ab da ändern sich auch die Steigungen. Sie werden nicht plötzlich leicht, aber sie verlieren ihren Schrecken und werden Teil eines neuen, vollständig erlernten Fahrgefühls. Kurzen Sprints oder knackigen Rampen bleiben dennoch eine klare Schwäche des Liegerads, es fehlt einfach der Wiegetritt."
      },
          {
        title:"Gleiten statt kämpfen – die Effizienz des Liegerads",
        text:"Auf der Geraden zeigt sich die eigentliche Stärke des Toxy TT. Man gleitet mit spürbar weniger Kraftaufwand dahin, wo das Gravelbike schon mehr Einsatz fordert. Das macht das Toxy TT zu einer echten Langstreckenmaschine. Die Wattzahlen bestätigen dieses Gefühl: Während man mit dem Gravelbike für eine zügige Reisegeschwindigkeit rund 200 Watt investiert, kommt man mit dem Liegerad oft schon mit etwa 150 Watt auf dasselbe Tempo – und hält es mühelos. Der aerodynamische Vorteil ist nicht nur messbar, sondern erlebbar. Auf dem Gravelbike stößt man ab einem bestimmten Tempo auf eine unsichtbare Barriere: die aerodynamische Wand. Beim Toxy TT fühlt sich das anders an. Der Widerstand steigt zwar ebenfalls, aber sanfter, gleichmäßiger. Man fährt nicht gegen etwas, sondern hinein. Geschwindigkeit wird nicht erkämpft, sondern erweitert. Spätestens wenn Gegenwind plötzlich Freundschaft schließen will, weiß man, dass die Physik auf der eigenen Seite steht."
      },
      {
        title:"Kleine Räder, große Unterschiede – Rollwiderstand im Jahresverlauf",
        text:"Die 20-Zoll-Räder des Toxy TT sind Wendigkeit und Kompaktheit in Reinform – aber sie haben ihren Preis beim Rollwiderstand. Im Sommer fällt das kaum ins Gewicht. Mit schnellen Reifen gleitet man leicht, und die Aerodynamik überkompensiert den Nachteil ohnehin. Doch im Winter beginnt ein anderes Kapitel: Der Continental Contact Urban, eigentlich ein hervorragender Reifen, wird bei niedrigen Temperaturen deutlich fester. Und was bei großen Laufrädern nur ein „etwas härter“ bedeutet, führt bei kleinen Rädern zu einer spürbaren Verlangsamung. Das Ergebnis lässt sich kaum ignorieren: 3–4 km/h weniger Reisegeschwindigkeit – allein durch die Temperatur.Pannenschutzreifen verstärken diesen Effekt sogar. Was bei 28 Zoll ein moderater Zusatzwiderstand ist, wird bei 20 Zoll geradezu vervielfacht." 
      },
      {
        title:"Die fragile Beziehung zwischen Liegerad und Schotter", 
        text:"Ein weiterer Punkt, der Liegeradfahrern oft erst unterwegs bewusst wird, ist die Beziehung zu unebenem Untergrund. Diese Beziehung ist – freundlich gesagt – fragil. Man kann Schotter fahren, natürlich. Aber man kann nicht aus dem Sattel gehen, um Unebenheiten abzufedern. Der Körper bleibt, wo er ist, während die Federung arbeitet. Auf solchen Passagen wird das Tempo zwangsläufig reduziert. Es ist eine Art stilles Abkommen zwischen Rad und Fahrer: Schnell, ja – aber bitte auf gutem Boden."
      },
      {
              title:"Stadt, Berge, schlechter Untergrund – die natürlichen Grenzen",
        text: "Das Toxy TT zeigt ganz klar, wofür es gebaut wurde und wofür nicht. Es ist nicht das ideale Rad für intensiven Stadtverkehr, für steile und enge Bergstraßen oder für dauerhaft schlechten Untergrund. Es kann das alles – aber man verliert Eleganz, Effizienz und Rhythmus. Auf langen, flachen Strecken mit gutem Asphalt jedoch spielt es in einer eigenen Liga."
      },
      {
        title:"Bremsen: Wo das Liegerad den Aufrechtradlern davonfährt",
        text:"Ein Punkt, der viele überrascht: der Bremsweg. Durch den niedrigen Schwerpunkt und die stabile Gewichtsverteilung bleibt das Liegerad beim Bremsen nahezu unerschütterlich. Ein Überschlag nach vorne ist praktisch ausgeschlossen. Dadurch lassen sich kräftige Vierkolben-Bremsanlagen erstmals in ihrer ganzen Wirkung nutzen – etwas, das auf vielen Upright-Bikes fast überdimensioniert wirkt. Beim Toxy TT ergibt es plötzlich Sinn."
      },
      {
        title:"Fazit: Kein Fahrrad für jeden – aber ein Fahrrad für sehr viel",
        text:"Das Toxy TT ist kein Universalwerkzeug. Es ist ein Spezialist – mit Stärken, die beeindruckend sind, und Schwächen, die klar definiert bleiben. Es ist kein Rad, das man intuitiv beherrscht, aber eines, das man gerne meistert. Wer bereit ist, die Lernphase zu akzeptieren, erhält ein Rad, das Komfort, Effizienz und ein völlig neues Fahrgefühl miteinander verbindet. Ein Rad, das Wind entschärft, lange Strecken verkürzt und Kinder zum Jubeln bringt. Ein Rad, das zeigt, wie angenehm Radfahren sein kann, wenn man sich traut, es anders zu tun. Am Ende bleibt eines: Das Toxy TT ist weniger ein alternatives Fahrrad, sondern eine alternative Art des Radfahrens."
      }
    ]
  },
  // RC Content-Triple
